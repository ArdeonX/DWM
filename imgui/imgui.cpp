...
const char* ImGui::GetStyleColorName(ImGuiCol idx)
{
    ...
    /*switch (idx)
    {
    case ImGuiCol_Text: return OBFUSCATE("Text");
    case ImGuiCol_TextDisabled: return OBFUSCATE("TextDisabled");
    case ImGuiCol_WindowBg: return OBFUSCATE("WindowBg");
    case ImGuiCol_ChildBg: return OBFUSCATE("ChildBg");
    case ImGuiCol_PopupBg: return OBFUSCATE("PopupBg");
    case ImGuiCol_Border: return OBFUSCATE("Border");
    case ImGuiCol_BorderShadow: return OBFUSCATE("BorderShadow");
    case ImGuiCol_FrameBg: return OBFUSCATE("FrameBg");
    case ImGuiCol_FrameBgHovered: return OBFUSCATE("FrameBgHovered");
    case ImGuiCol_FrameBgActive: return OBFUSCATE("FrameBgActive");
    case ImGuiCol_TitleBg: return OBFUSCATE("TitleBg");
    case ImGuiCol_TitleBgActive: return OBFUSCATE("TitleBgActive");
    case ImGuiCol_TitleBgCollapsed: return OBFUSCATE("TitleBgCollapsed");
    case ImGuiCol_MenuBarBg: return OBFUSCATE("MenuBarBg");
    case ImGuiCol_ScrollbarBg: return OBFUSCATE("ScrollbarBg");
    case ImGuiCol_ScrollbarGrab: return OBFUSCATE("ScrollbarGrab");
    case ImGuiCol_ScrollbarGrabHovered: return OBFUSCATE("ScrollbarGrabHovered");
    case ImGuiCol_ScrollbarGrabActive: return OBFUSCATE("ScrollbarGrabActive");
    case ImGuiCol_CheckMark: return OBFUSCATE("CheckMark");
    case ImGuiCol_SliderGrab: return OBFUSCATE("SliderGrab");
    case ImGuiCol_SliderGrabActive: return OBFUSCATE("SliderGrabActive");
    case ImGuiCol_Button: return OBFUSCATE("Button");
    case ImGuiCol_ButtonHovered: return OBFUSCATE("ButtonHovered");
    case ImGuiCol_ButtonActive: return OBFUSCATE("ButtonActive");
    case ImGuiCol_Header: return OBFUSCATE("Header");
    case ImGuiCol_HeaderHovered: return OBFUSCATE("HeaderHovered");
    case ImGuiCol_HeaderActive: return OBFUSCATE("HeaderActive");
    case ImGuiCol_Separator: return OBFUSCATE("Separator");
    case ImGuiCol_SeparatorHovered: return OBFUSCATE("SeparatorHovered");
    case ImGuiCol_SeparatorActive: return OBFUSCATE("SeparatorActive");
    case ImGuiCol_ResizeGrip: return OBFUSCATE("ResizeGrip");
    case ImGuiCol_ResizeGripHovered: return OBFUSCATE("ResizeGripHovered");
    case ImGuiCol_ResizeGripActive: return OBFUSCATE("ResizeGripActive");
    case ImGuiCol_Tab: return OBFUSCATE("Tab");
    case ImGuiCol_TabHovered: return OBFUSCATE("TabHovered");
    case ImGuiCol_TabActive: return OBFUSCATE("TabActive");
    case ImGuiCol_TabUnfocused: return OBFUSCATE("TabUnfocused");
    case ImGuiCol_TabUnfocusedActive: return OBFUSCATE("TabUnfocusedActive");
    case ImGuiCol_PlotLines: return OBFUSCATE("PlotLines");
    case ImGuiCol_PlotLinesHovered: return OBFUSCATE("PlotLinesHovered");
    case ImGuiCol_PlotHistogram: return OBFUSCATE("PlotHistogram");
    case ImGuiCol_PlotHistogramHovered: return OBFUSCATE("PlotHistogramHovered");
    case ImGuiCol_TextSelectedBg: return OBFUSCATE("TextSelectedBg");
    case ImGuiCol_DragDropTarget: return OBFUSCATE("DragDropTarget");
    case ImGuiCol_NavHighlight: return OBFUSCATE("NavHighlight");
    case ImGuiCol_NavWindowingHighlight: return OBFUSCATE("NavWindowingHighlight");
    case ImGuiCol_NavWindowingDimBg: return OBFUSCATE("NavWindowingDimBg");
    case ImGuiCol_ModalWindowDimBg: return OBFUSCATE("ModalWindowDimBg");
    }
    IM_ASSERT(0);
...
void ImGui::UpdateDebugToolItemPicker()
{
    ...
    if (g.DebugItemPickerActive)
    {
        ...
        ImGui::BeginTooltip();
        ImGui::Text("H: 0x%08X", hovered_id);
        ImGui::Text(".");
...
void ImGui::Initialize(ImGuiContext* context)
{
    ...
    // Add .ini handle for ImGuiWindow type
    {
        ...
        ini_handler.TypeName = "Disp";
        ini_handler.TypeHash = ImHashStr("Disp");
...
static void ImGui::ErrorCheckBeginEndCompareStacksSize(ImGuiWindow* window, bool write)
{
    ...
    { int n = window->IDStack.Size;       if (write) *p = (short)n; else IM_ASSERT(*p == n && "");   p++; }    // Too few or too many PopID()/TreePop()
    { int n = window->DC.GroupStack.Size; if (write) *p = (short)n; else IM_ASSERT(*p == n && "");                p++; }    // Too few or too many EndGroup()

    // Global stacks
    // For color, style and font stacks there is an incentive to use Push/Begin/Pop/.../End patterns, so we relax our checks a little to allow them.
    { int n = g.BeginPopupStack.Size;     if (write) *p = (short)n; else IM_ASSERT(*p == n && ""); p++; }// Too few or too many EndMenu()/EndPopup()
    { int n = g.ColorModifiers.Size;      if (write) *p = (short)n; else IM_ASSERT(*p >= n && "");       p++; }    // Too few or too many PopStyleColor()
    { int n = g.StyleModifiers.Size;      if (write) *p = (short)n; else IM_ASSERT(*p >= n && "");           p++; }    // Too few or too many PopStyleVar()
    { int n = g.FontStack.Size;           if (write) *p = (short)n; else IM_ASSERT(*p >= n && "");                   p++; }    // Too few or too many PopFont()
...
void ImGui::BeginTooltipEx(ImGuiWindowFlags extra_flags, ImGuiTooltipFlags tooltip_flags)
{
    ...
    char window_name[16];
    ImFormatString(window_name, IM_ARRAYSIZE(window_name), "ip_%02d", g.TooltipOverrideCount);
...
void ImGui::OpenPopupEx(ImGuiID id, ImGuiPopupFlags popup_flags)
{
    ...
    IMGUI_DEBUG_LOG_POPUP("O(0x%08X)\n", id);
...
bool ImGui::BeginPopupEx(ImGuiID id, ImGuiWindowFlags flags)
{
    ...
    if (flags & ImGuiWindowFlags_ChildMenu)
        ImFormatString(name, IM_ARRAYSIZE(name), "m_%02d", g.BeginPopupStack.Size); // Recycle windows based on depth
    else
        ImFormatString(name, IM_ARRAYSIZE(name), "p_%08x", id); // Not recycling, so we can close/open during the same frame
...
static const char* GetFallbackWindowNameForWindowingList(ImGuiWindow* window)
{
    if (window->Flags & ImGuiWindowFlags_Popup)
        return "";
    if ((window->Flags & ImGuiWindowFlags_MenuBar) && strcmp(window->Name, "") == 0)
        return "";
    return "";
}
...
void ImGui::NavUpdateWindowingOverlay()
{
    ...
    if (g.NavWindowingListWindow == NULL)
        g.NavWindowingListWindow = FindWindowByName("N");
    SetNextWindowSizeConstraints(ImVec2(g.IO.DisplaySize.x * 0.20f, g.IO.DisplaySize.y * 0.20f), ImVec2(FLT_MAX, FLT_MAX));
    SetNextWindowPos(g.IO.DisplaySize * 0.5f, ImGuiCond_Always, ImVec2(0.5f, 0.5f));
    PushStyleVar(ImGuiStyleVar_WindowPadding, g.Style.WindowPadding * 2.0f);
    Begin("N", NULL, ImGuiWindowFlags_NoTitleBar | ImGuiWindowFlags_NoFocusOnAppearing | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoMove | ImGuiWindowFlags_NoInputs | ImGuiWindowFlags_AlwaysAutoResize | ImGuiWindowFlags_NoSavedSettings);
...
static void WindowSettingsHandler_ReadLine(ImGuiContext*, ImGuiSettingsHandler*, void* entry, const char* line)
{
    ...
    int x, y;
    int i;
    if (sscanf(line, "P%i,%i", &x, &y) == 2)         { settings->Pos = ImVec2ih((short)x, (short)y); }
    else if (sscanf(line, "S%i,%i", &x, &y) == 2)   { settings->Size = ImVec2ih((short)x, (short)y); }
    else if (sscanf(line, "C%d", &i) == 1)     { settings->Collapsed = (i != 0); }
}
